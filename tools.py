...
def plot_alignment(transformed_source, target, name, title=None):
    ...
    poly_source = Poly3DCollection(
        faces_vertices_source, alpha=0.5, edgecolor="k", linewidths=0.5
    )
    ...
    poly_target = Poly3DCollection(
        faces_vertices_target, alpha=0.5, edgecolor="k", linewidths=0.5
    )
